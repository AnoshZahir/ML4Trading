...
from analysis import get_port_SPY, get_portfolio_value
...
def error_alloc(allocs, portfolio, start_val = 1):
...
def optimise_portfolio(sd, ed, syms, rfr = 0.0, sf = 252, gen_plot = True):
    ...
    optimised_alloc = find_optimised_alloc(port, error_alloc)
